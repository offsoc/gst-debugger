...
Command CommandFactory::make_pad_watch_command(bool enable, PadWatch_WatchType watch_type, const std::string &pad_path, int qe_type)
{
	Command cmd;
...
Command CommandFactory::make_property_request_command(const std::string &element_path, const std::string &property_name)
{
	Command cmd;
...
Command CommandFactory::make_message_request_command(int message_type)
{
...
Command CommandFactory::make_set_threshold_command(const std::string &threshold_list, bool overwrite)
{
	Command cmd;
...
Command CommandFactory::make_set_log_watch_command(bool enable, int log_level)
{
	Command cmd;
...
Command CommandFactory::make_request_debug_categories_command()
{
	Command cmd;
...
Command CommandFactory::make_request_topology_command()
{
	Command cmd;
